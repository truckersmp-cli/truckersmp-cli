...
On Linux it's possible to start TruckersMP through [Proton][github:proton]. A working [native Steam][repology:steam] installation is needed for this which has the desired game [*not uninstalled*][github:issue129]. SteamCMD can use your saved credentials for convenience.
